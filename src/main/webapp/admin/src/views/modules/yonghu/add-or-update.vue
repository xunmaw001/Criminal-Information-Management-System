<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="民警姓名" prop="minjingxingming">
          <el-input v-model="ruleForm.minjingxingming" 
              placeholder="民警姓名" clearable  :readonly="ro.minjingxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="民警姓名" prop="minjingxingming">
              <el-input v-model="ruleForm.minjingxingming" 
                placeholder="民警姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	shouji : false,
      ...
      rules: {
          minjingzhanghao: [
                { required: true, message: '民警账号不能为空', trigger: 'blur' },
          ],
          mima: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mima = true;
          ...
          if(o=='minjingxingming'){
            this.ruleForm.minjingxingming = obj[o];
	    this.ro.minjingxingming = true;
            continue;
          }
          if(o=='xingbie'){
