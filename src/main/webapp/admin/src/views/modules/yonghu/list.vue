    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                <el-form-item :label="contents.inputTitle == 1 ? '民警账号' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.minjingzhanghao" placeholder="民警账号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.minjingzhanghao" placeholder="民警账号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.minjingzhanghao" placeholder="民警账号" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '民警姓名' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.minjingxingming" placeholder="民警姓名" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.minjingxingming" placeholder="民警姓名" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.minjingxingming" placeholder="民警姓名" clearable></el-input>
                </el-form-item>
          <el-form-item>
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="民警账号">
		     <template slot-scope="scope">
                ...
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="minjingxingming"
                    header-align="center"
		    label="民警姓名">
		     <template slot-scope="scope">
                       {{scope.row.minjingxingming}}
                     </template>
                </el-table-column>
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="xingbie"
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.minjingzhanghao!='' && this.searchForm.minjingzhanghao!=undefined){
            params['minjingzhanghao'] = '%' + this.searchForm.minjingzhanghao + '%'
          }
          if(this.searchForm.minjingxingming!='' && this.searchForm.minjingxingming!=undefined){
            params['minjingxingming'] = '%' + this.searchForm.minjingxingming + '%'
          }
      this.$http({
        url: "yonghu/page",
        method: "get",
